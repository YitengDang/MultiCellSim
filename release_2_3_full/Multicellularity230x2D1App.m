classdef Multicellularity230x2D1App < handle
    %
    % Usage:
    %     app.Multicellularity230x2D1App
    ...
    properties (Constant)
        AppPathBase = {'/Multicellularity23 - 1/code'};
        AppClass = 'Multicellularity230x2D1App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = Multicellularity230x2D1App()
        ...
        function startApp(obj)
            ...
            mlock;
            Multicellularity230x2D1App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'app_R2_3_v5')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong app_R2_3_v5
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'app_R2_3_v5').getString, ...
            ...
            if nargout(@app_R2_3_v5) == 0
                eval('app_R2_3_v5');
            else
                obj.AppHandle = eval('app_R2_3_v5');
            end
