classdef MulticellularautomatonappApp < handle
    %
    % Usage:
    %     app.MulticellularautomatonappApp
    ...
    properties (Constant)
        AppPathBase = {'/Multicellularautomatonapp'};
        AppClass = 'MulticellularautomatonappApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = MulticellularautomatonappApp()
        ...
        function startApp(obj)
            ...
            mlock;
            MulticellularautomatonappApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'app_R2_4_v5_R2018b')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong app_R2_4_v5_R2018b
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'app_R2_4_v5_R2018b').getString, ...
            ...
            if nargout(@app_R2_4_v5_R2018b) == 0
                eval('app_R2_4_v5_R2018b');
            else
                obj.AppHandle = eval('app_R2_4_v5_R2018b');
            end
